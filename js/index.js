!(function () {
            ...
            const { root: t, namespace: n = "contact-form-7/v1" } = wpcf7.api,
                a = s.reduceRight(
                    ...
                    (e) => {
                        ...
                        "string" == typeof r && ((a = n.replace(/^\/|\/$/g, "")), (o = r.replace(/^\//, "")), (s = o ? a + "/" + o : a)),
                            "string" == typeof s && (-1 !== t.indexOf("?") && (s = s.replace("?", "&")), (s = s.replace(/^\//, "")), (i = t + s)),
        ...
        d = function (e) {
            ...
            if (
                !t.every((e) => {
                    ...
                    try {
                        return ((e) => -1 !== ["http", "https", "ftp", "ftps", "mailto", "news", "irc", "irc6", "ircs", "gopher", "nntp", "feed", "telnet", "mms", "rtsp", "sms", "svn", "tel", "fax", "xmpp", "webcal", "urn"].indexOf(e))(
                            new URL(e).protocol.replace(/:$/, "")
                        );
                    } catch {
                        return !1;
                    }
    ...
    function L(e) {
        ...
        i({ endpoint: `contact-forms/${e.wpcf7.id}/feedback`, method: "POST", body: n, wpcf7: { endpoint: "feedback", form: e, detail: s } })
            .then((t) => {
    ...
    function z(e) {
        ...
        i({ endpoint: `contact-forms/${e.wpcf7.id}/refill`, method: "GET", wpcf7: { endpoint: "refill", form: e, detail: n } })
            .then((t) => {
